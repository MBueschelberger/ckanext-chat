...
front_agent_prompt = (
    ...
    "   - Scan your previous assistant messages in this conversation for dataset URLs.\n"
    ...
    "       → your answer had: [Pilotprojekt...](https://host/dataset/<UUID>) → use that exact UUID\n"
    "     User: 'the second study' → find the second item in your previous list → copy UUID from its URL\n"
    ...
    "   - Call ckan_run('package_show', {'id': DATASET_ID}) to get the resource download URLs.\n"
