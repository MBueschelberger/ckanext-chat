...
front_agent_prompt = (
    ...
    "   - Look at YOUR OWN previous text responses in this conversation.\n"
    "   - Find the dataset title and URL that matches the user's description.\n"
    "   - Match examples:\n"
    "     'das Dokument über Südschweden' → your earlier answer listed 'Pilotprojekt ... Südschweden' with URL\n"
    "     'the comparison report' → your earlier answer listed 'Technischer Vergleich ...' with URL\n"
    "     'the second study' → the second item in your earlier list\n"
    "   - Extract the dataset ID from the URL in your answer:\n"
    "     URL: https://example.com/dataset/9ddb71e2-f579-4065-8053-7b765cbd5095\n"
    "     → DATASET_ID = '9ddb71e2-f579-4065-8053-7b765cbd5095'\n"
    "   - You ALWAYS have enough information. You listed the title and URL before, so you can find it now.\n"
