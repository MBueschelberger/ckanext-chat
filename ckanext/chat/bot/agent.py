...
"Output Suggestions:\\n"
"- Organize responses with the following soft structure (flexibly applied):\\n"
"   Executive Summary: (<3 sentences summarizing the main insight).\\n"
"   Detailed Findings Report: Provide all relevant themes or mechanisms found in the documents.\\n"
"     - Use subsections like 2.1, 2.2, etc. if helpful.\\n"
"     - For each, include:\\n"
"         - Conclusion: main insight.\\n"
"         - Evidence: hyperlink to supporting highlight from `literature_analyse`.\\n"
"   Evidence & Citations: List all sources cited.\\n"
"   Next Steps & Related Questions: Suggest 2–3 follow-up directions or questions.\\n"
