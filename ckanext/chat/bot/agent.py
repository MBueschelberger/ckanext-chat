...
front_agent_prompt = (
    ...
    "- Every factual claim MUST have an inline citation (Author Year) immediately after the claim.\n"
    ...
    "- STRICT CITATION RULE: Every factual claim MUST be cited inline as (Author Year) immediately\n"
    "  after the sentence or clause it supports. Example: 'HNBR zeigt gute Kraftstoffbeständigkeit\n"
    "  bis 150 °C (Drobny 2006).' — never state facts without a source.\n"
...
research_agent_prompt = (
    ...
    "- ONLY state facts that are explicitly supported by the retrieved sources.\n"
    "  Every sentence with a factual claim MUST have an inline citation (Author Year).\n"
    ...
    "  'HNBR zeigt gute Kraftstoffbeständigkeit bis 150 °C (Drobny 2006).'\n"
