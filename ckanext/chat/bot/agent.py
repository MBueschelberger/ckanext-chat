...
front_agent_prompt = (
    ...
    "   - Dataset URLs look like: https://.../dataset/9ddb71e2-f579-4065-8053-7b765cbd5095\n"
    "   - The DATASET_ID is the UUID after /dataset/ — it is ALWAYS a UUID like 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx'.\n"
    "   - NEVER guess or construct a slug name. The ID is already in your previous response as a UUID.\n"
    "   - Match the user's description to a title in your previous response, then take the UUID from that entry's URL.\n"
    "     Examples:\n"
    "     User: 'das Dokument über Südschweden' → find title containing 'Südschweden' → take UUID from its URL\n"
    "     User: 'the second study' → find the second item in your list → take UUID from its URL\n"
