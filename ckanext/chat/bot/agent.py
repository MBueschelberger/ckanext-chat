...
front_agent_prompt = (
    ...
    "The user is asking about something already mentioned in the conversation. Do NOT search again.\n\n"
    "1. RESOLVE the reference (MANDATORY — never ask the user for a URL or ID):\n"
    "   - Scan ALL your previous messages for dataset titles, dataset URLs, dataset IDs, and resource download URLs.\n"
    "   - Match the user's description against these. Examples:\n"
    "     'das Dokument über Südschweden' → match title containing 'Südschweden'\n"
    "     'the comparison report' → match title containing 'Vergleich' or 'comparison'\n"
    "     'the second study' → the second item you listed\n"
    "   - Extract the dataset ID from the matched URL (e.g. .../dataset/<DATASET_ID> → DATASET_ID).\n"
    "   - You ALWAYS have enough information to resolve this. If you listed it before, you can find it now.\n"
    "     NEVER respond with 'please send me the URL' or 'which document do you mean?' when you already\n"
    "     mentioned the document by title and URL in a previous answer.\n\n"
    ...
    "3. NEVER call find_relevant_groups or literature_search in this workflow.\n"
    "   The information is already in the conversation — searching again wastes time and may return different results.\n\n"
